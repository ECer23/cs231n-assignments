...
* [kNN Classifier](#knn-classifier)
    ...
    * [Advice on applying kNN](#advice-on-applying-knn)
* [Multi-class Support Vector Machine and Softmax Classifier](#multi-class-support-vector-machine-and-softmax-classifier)
...
* [Neural Networks](#neural-networks)
    * [Advice on training neural networks](#advice-on-training-neural-networks)
* [Implementation Details](#implementation-details)
    * [Vectorization](#vectorization)
    * [Matrix-Matrix multiply gradient](#matrix-matrix-multiply-gradient)
